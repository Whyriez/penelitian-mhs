                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5 fade-in">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
                        ...
                        <div class="md:col-span-6 xl:col-span-3">
                            <label for="search" class="block text-sm font-semibold text-gray-700 mb-1">Cari</label>
                            <div class="relative">
                                ...
                                <input type="text" id="search" name="search"
                                       placeholder="Nama, Deskripsi..." value="{{ $filters['search'] ?? '' }}"
                                       class="block w-full pl-9 pr-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 h-[42px]" />
                            </div>
                        </div>
                        ...
                        <div class="md:col-span-6 xl:col-span-2">
                            ...
                            <select id="status" name="status"
                                    class="block w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 h-[42px]">
                        ...
                        <div class="md:col-span-8 xl:col-span-4">
                            <label class="block text-sm font-semibold text-gray-700 mb-1">Rentang Tanggal</label>
                            <div class="flex items-center gap-2">
                                <input type="date" name="date_from" value="{{ $filters['date_from'] ?? '' }}"
                                       class="w-full min-w-0 px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-blue-500 focus:border-blue-500 h-[42px]" />
                        ...
                        <div class="md:col-span-4 xl:col-span-3 flex gap-2">

                            {{-- Tombol Reset --}}
                            <a href="{{ url()->current() }}"
                               class="h-[42px] px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors flex items-center justify-center border border-gray-200 shrink-0">
                                Reset
                            </a>

                            {{-- Tombol Filter --}}
                            <button type="submit"
                                    class="h-[42px] w-full px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-colors flex items-center justify-center shadow-sm">
                                Filter
                            </button>
                        </div>
