...
<head>
    ...
    <title>Daftar - Sistem Arsip Izin Penelitian Mahasiswa</title>
    ...
    <div class="min-h-full grid grid-cols-1 lg:grid-cols-2 split-screen">
        <div class="illustration-container hidden lg:flex items-center justify-center p-8 slide-in-left">
            <div class="max-w-md text-center text-white">
                <div class="mb-6">
                    <svg class="w-48 h-48 mx-auto" viewbox="0 0 400 400" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <circle cx="200" cy="200" r="180" fill="rgba(255,255,255,0.1)"
                            stroke="rgba(255,255,255,0.2)" stroke-width="2" />
                        <rect x="120" y="140" width="80" height="100" rx="8" fill="rgba(255,255,255,0.9)"
                            stroke="rgba(255,255,255,0.3)" stroke-width="2" />
                        <rect x="130" y="130" width="80" height="100" rx="8" fill="rgba(255,255,255,0.8)"
                            stroke="rgba(255,255,255,0.3)" stroke-width="2" />
                        <rect x="140" y="120" width="80" height="100" rx="8" fill="rgba(255,255,255,0.7)"
                            stroke="rgba(255,255,255,0.3)" stroke-width="2" />
                        <rect x="150" y="110" width="80" height="100" rx="8" fill="white"
                            stroke="rgba(59,130,246,0.3)" stroke-width="2" />
                        <line x1="160" y1="130" x2="210" y2="130" stroke="#3b82f6"
                            stroke-width="2" stroke-linecap="round" />
                        <line x1="160" y1="140" x2="200" y2="140" stroke="#60a5fa"
                            stroke-width="2" stroke-linecap="round" />
                        <line x1="160" y1="150" x2="220" y2="150" stroke="#60a5fa"
                            stroke-width="2" stroke-linecap="round" />
                        <line x1="160" y1="160" x2="190" y2="160" stroke="#93c5fd"
                            stroke-width="2" stroke-linecap="round" />
                        <circle cx="200" cy="180" r="15" fill="#10b981" />
                        <path d="M193 180l4 4 8-8" stroke="white" stroke-width="2" fill="none" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path d="M200 260 L170 280 L170 310 Q170 320 200 325 Q230 320 230 310 L230 280 Z"
                            fill="rgba(255,255,255,0.8)" stroke="rgba(255,255,255,0.3)" stroke-width="2" />
                        ...
                        <path d="M200 280 L180 290 L180 320 Q180 330 200 335 Q220 330 220 320 L220 290 Z"
                            fill="rgba(255,255,255,0.8)" stroke="rgba(255,255,255,0.3)" stroke-width="2" />
                        <path d="M190 300 L195 305 L210 290" stroke="#10b981" stroke-width="2" fill="none"
